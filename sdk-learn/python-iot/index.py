...
endpoint = "a37bz4hrf4lhrt-ats.iot.us-east-1.amazonaws.com"
port = 8883
client_id = "hidahidahida"
topic = "hidatopic"
...
def generate_sensor_data():
    ...
    wind_speed = round(random.uniform(0, 50), 2)  # Random gas concentration between 0 and 500 ppm
    distance = round(random.uniform(0, 500), 2)  # Random gas concentration between 0 and 500 ppm
    return {
        "timestamp": timestamp,
